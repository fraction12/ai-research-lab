# prefix-block-store Specification

## Purpose
Build content-addressed prompt block metadata that classifies attention-sink candidates, stable prefix blocks, rolling-tail candidates, and volatile tails before real KV persistence work begins.
