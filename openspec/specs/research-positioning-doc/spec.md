# research-positioning-doc Specification

## Purpose
Maintain a source-backed positioning record for SSD-native local-agent inference research so public claims and future paper framing distinguish established prior art from the project's specific workload and persistence wedge.
