# large-agent-prefix-benchmark-fixture Specification

## Purpose
Generate sanitized, size-targeted large-prefix workflow fixtures so local-agent cache experiments can measure whether reusable-prefix value grows as agent context becomes more realistic.
